...
export const TemplateGallery: React.FC = () => {
  ...
  }, [filteredTemplates, isFiltering, visibleCount]);
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden bg-slate-950">
                    ...
                    <div className="absolute top-2.5 left-2.5 flex items-center gap-1.5">
                      ...
                      {template.popular && (
                        <span className="bg-amber-500 text-slate-950 text-xs font-extrabold px-2.5 py-0.5 rounded-md flex items-center gap-1 shadow-sm">
                    ...
                    <div>
                      ...
                      <div className="mt-3 flex flex-wrap gap-1.5">
                        {(template.features || []).slice(0, 3).map((feat, fIdx) => (
                          <span
                            key={fIdx}
                            className="bg-slate-800/80 text-slate-300 border border-slate-700/60 text-xs font-medium px-2.5 py-0.5 rounded-md"
                          >
                            {feat}
                          </span>
                        ))}
